 ...
 *
 * Dispatches 'eb-period-change' CustomEvent on document so that
 * all eb-chart-card instances on the same page react to the selection.
 *
...
class SEMPeriodSelectorCard extends SEMLitBase {
    ...
    _dispatchPeriod(key) {
        ...
        document.dispatchEvent(new CustomEvent('eb-period-change', {
            detail: { ...period, key },
        }));
    }
...
semDefineCard('eb-period-selector-card', SEMPeriodSelectorCard, {
    type: 'custom:eb-period-selector-card',

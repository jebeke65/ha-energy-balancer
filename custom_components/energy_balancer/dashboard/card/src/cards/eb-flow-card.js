...
class SEMFlowCard extends SEMLitBase {
    ...
    setConfig(config) {
        ...
        if (config.entity_prefix) {
            ...
            throw new Error('eb-flow-card requires either "entities" or "entity_prefix" config');
        }
    ...
    set hass(hass) {
        ...
        // diverged between eb-flow-card and eb-system-diagram-card
    ...
    _resolveEntity(key) {
        ...
        const map = {
            ...
            ev_charger_count: e.ev?.charger_count || 'sensor.ebi_ev_charger_count',
        };
        return map[key] || null;
    }
    ...
    static async getConfigElement() {
        return document.createElement('eb-flow-card-editor');
    }
...
semDefineCard('eb-flow-card', SEMFlowCard, {
    type: 'eb-flow-card',
    name: 'SEM Flow Card',

 ...
 * periods. Visual design identical to the original eb-schedule-card.js; only the
 * DOM management strategy changes (Lit reactive render vs innerHTML patching).
 *
 * Config:
 *   type: custom:eb-schedule-card
 *   entity_prefix: sensor.ebi_   # default
 */

import { SEMLitBase, html, css, nothing } from '../base/eb-lit-base.js';
import { semTheme, semDefineCard, SEM_COLORS } from '../base/eb-shared.js';
...
semDefineCard('eb-schedule-card', SEMScheduleCard, {
    type: 'eb-schedule-card',
    name: 'SEM Schedule',

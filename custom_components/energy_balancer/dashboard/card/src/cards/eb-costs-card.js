 ...
 *
 * Config:
 *   type: custom:eb-costs-card
 *   entity_prefix: sensor.ebi_   # default
 */

import { SEMLitBase, html, css, nothing } from '../base/eb-lit-base.js';
import { semTheme, semGetCurrency, semDefineCard } from '../base/eb-shared.js';
...
class SEMCostsCard extends SEMLitBase {
    ...
    static getStubConfig() { return { entity_prefix: 'sensor.ebi_' }; }
}

semDefineCard('eb-costs-card', SEMCostsCard, {
    type: 'eb-costs-card',
    name: 'SEM Costs',

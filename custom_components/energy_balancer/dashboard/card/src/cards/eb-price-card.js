 ...
 * everything from sensor.ebi_tariff_current_import_rate (+ its attributes):
 ...
 *
 * Config:
 *   type: custom:eb-price-card
 *   entity: sensor.ebi_tariff_current_import_rate   # default
 */

import { SEMLitBase, html, css, svg, nothing } from '../base/eb-lit-base.js';
import { semDefineCard } from '../base/eb-shared.js';

const DEFAULT_ENTITY = 'sensor.ebi_tariff_current_import_rate';
const LEVELS = {
...
semDefineCard('eb-price-card', SEMPriceCard, {
    type: 'custom:eb-price-card',
    name: 'SEM Price Card',

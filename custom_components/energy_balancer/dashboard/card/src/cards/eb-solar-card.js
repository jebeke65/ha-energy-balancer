...
class SEMSolarCard extends SEMLitBase {
    ...
    // True only when the backing entity actually exists and has a usable state.
    // Used to hide whole sections whose sensors this backend doesn't provide.
    _exists(suffix) {
    ...
    render() {
        ...
        // Only render these sections when the backend actually provides the sensors.
        const hasFlows = ['flow_solar_to_home_energy', 'flow_solar_to_battery_energy',
                          'flow_solar_to_ev_energy', 'flow_solar_to_grid_energy']
                         .some(s => this._exists(s));
        const hasPerf  = ['pv_daily_specific_yield', 'pv_performance_vs_forecast',
                ...
                <div class="wrap">
                    ...
                    <div class="section two-col">
                        <div>
                            ...
                            ${this._exists('best_surplus_window') ? html`
                            <div class="metric-row">
...
semDefineCard('eb-solar-card', SEMSolarCard, {
    type: 'eb-solar-card',
    name: 'SEM Solar',

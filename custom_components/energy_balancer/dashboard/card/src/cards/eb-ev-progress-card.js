 ...
 *
 * Entities watched:
 *   sensor.ebi_daily_ev_energy
 *   sensor.ebi_lifetime_ev_energy
 *   sensor.ebi_lifetime_ev_solar_share
 *   sensor.ebi_lifetime_ev_cost
 *   sensor.ebi_lifetime_ev_sessions
 *   number.ebi_daily_ev_target
 */

import { SEMLitBase, html, css, nothing } from '../base/eb-lit-base.js';
import { semTheme, semDefineCard, semGetCurrency } from '../base/eb-shared.js';
...
class SEMEvProgressCard extends SEMLitBase {
    ...
    static get watchedEntities() {
        return [
            ...
            'number.ebi_charger_ev_charger_daily_ev_target',
        ];
    }
    ...
    _evDailyTarget() {
        ...
        const re = new RegExp(`^number\\.${this._objPrefix()}charger_.+_daily_ev_target$`);
        ...
        return this._state(`number.${this._objPrefix()}daily_ev_target`, 10);
    }

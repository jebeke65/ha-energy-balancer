 ...
 *
 * Reads sensor.ebi_charging_state.attributes.today_plan (computed by the
 ...
 *
 * Config:
 *   type: custom:eb-today-plan-card
 *   entity: sensor.ebi_charging_state   # default
 */

import { SEMLitBase, html, css, nothing } from '../base/eb-lit-base.js';
import { semDefineCard, semFormatTime } from '../base/eb-shared.js';

const DEFAULT_ENTITY = 'sensor.ebi_charging_state';
...
semDefineCard('eb-today-plan-card', SEMTodayPlanCard, {

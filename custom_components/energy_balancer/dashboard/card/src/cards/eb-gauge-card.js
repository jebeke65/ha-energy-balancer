 ...
 *
 * Config:
 *   type: custom:eb-gauge-card
 *   entity: sensor.ebi_self_consumption_rate
...
class SEMGaugeCard extends SEMLitBase {
    ...
    setConfig(config) {
        if (!config.entity) throw new Error('eb-gauge-card requires entity');
    ...
    static getStubConfig() { return { entity: 'sensor.ebi_self_consumption_rate' }; }
}

semDefineCard('eb-gauge-card', SEMGaugeCard, {
    type: 'custom:eb-gauge-card',
    name: 'SEM Gauge Card',
